...
<html data-wf-domain="interactive-sky.webflow.io" data-wf-page="5d971c4989c88c6dcbca55ce" data-wf-site="5d971c4989c88c0b4cca55cd">
    ...
    <body>
        <div id="demo" class="wrapp">
            ...
            <h1>Karim Hazimeh</h1>
            <div class="text-block" style="font-family:Lucida Console"><br>a Data detective with a Masters in Business Analytics🕵🏻‍♀️.</br>Being a Tech Savvy and a Data Science enthusiast, I strive to deliver <b>Data driven</b> solutions for end users.</div>
...
st.components.v1.html(html_code,height=1815 ,width=1885)
